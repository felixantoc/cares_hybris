...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/assuramedstorefront/electronics/en",
						"https://electronics.local:9002/assuramedstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/assuramedstorefront/electronics/en",
						"https://electronics.local:9002/assuramedstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/assuramedstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/assuramedstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/assuramedstorefront/electronics/en",
						"https://electronics.local:9002/assuramedstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/assuramedstorefront",
						"https://electronics.local:9002/assuramedstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/assuramedstorefront",
						"https://electronics.local:9002/assuramedstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/assuramedstorefront/electronics/en",
						"https://electronics.local:9002/assuramedstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
