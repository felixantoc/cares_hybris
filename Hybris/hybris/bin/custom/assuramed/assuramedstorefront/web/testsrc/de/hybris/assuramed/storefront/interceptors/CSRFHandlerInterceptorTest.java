 ...
 *  
 */
package de.hybris.assuramed.storefront.interceptors;
...
import de.hybris.assuramed.storefront.util.CSRFHandlerInterceptor;
import de.hybris.assuramed.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "de.hybris.assuramed.storefront.util.CSRFTokenManager.tokenval";
