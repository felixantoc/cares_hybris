 ...
 *  
 */
package de.hybris.assuramed.test.setup;
...
import de.hybris.assuramed.test.constants.AssuramedTestConstants;
import de.hybris.assuramed.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = AssuramedTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/assuramedtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/assuramedtest/import/reviews.impex");
			...
			importImpexFile(context, "/assuramedtest/import/cstickets.impex");
		}
	}
}
