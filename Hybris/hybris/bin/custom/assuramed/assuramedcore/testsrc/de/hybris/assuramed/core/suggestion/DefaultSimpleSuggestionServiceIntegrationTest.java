 ...
 *  
 */
package de.hybris.assuramed.core.suggestion;
...
import de.hybris.assuramed.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/assuramedcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
