 ...
 *  
 */
package de.hybris.assuramed.core.hmc;
...
/**
 * Provides necessary meta information about the assuramedcore hmc extension.
 * 
 * 
 * @version ExtGen v4.1
 */
public class AssuramedCoreHMCExtension extends HMCExtension
{
	/** Edit the local|project.properties to change logging behavior (properties log4j.*). */
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(AssuramedCoreHMCExtension.class.getName());

	/** Path to the resource bundles. */
	public static final String RESOURCE_PATH = "de.hybris.assuramed.core.hmc.locales";
