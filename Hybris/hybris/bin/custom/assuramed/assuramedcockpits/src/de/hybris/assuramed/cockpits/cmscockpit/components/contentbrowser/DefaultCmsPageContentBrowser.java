 ...
 *  
 */
package de.hybris.assuramed.cockpits.cmscockpit.components.contentbrowser;
...
import de.hybris.assuramed.cockpits.cmscockpit.session.impl.DefaultCmsPageBrowserModel;
