 ...
 *  
 */
package de.hybris.assuramed.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(AssuramedFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AssuramedFulfilmentProcessConstants.PARENT_PROCESS);
