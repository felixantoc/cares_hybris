 ...
 *  
 */
package de.hybris.assuramed.fulfilmentprocess.test.jobs;
...
import de.hybris.assuramed.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = AssuramedFulfilmentProcessConstants.ORDER_PROCESS_NAME;
